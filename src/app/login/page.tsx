      ...
      <div className="w-full max-w-md">
        ...
        <div className="bg-card rounded-[0.625rem] shadow-card border border-border p-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            {showForgotPassword && (
              <div className="p-4 bg-warning/10 border border-warning/30 rounded-[0.625rem] text-sm">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <p className="font-medium text-card-foreground mb-1">Password Reset</p>
                    <p className="text-muted-foreground">
                      To reset your password, please contact the school secretary. They will verify your identity and provide you with new credentials.
                    </p>
                  </div>
                </div>
                <button
                  ...
                  className="mt-3 text-xs text-muted-foreground hover:text-card-foreground"
                >
                  Dismiss
                </button>
              </div>
